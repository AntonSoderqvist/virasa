...
public:
	...
	/**
	 * @brief Append the panel background and text commands to a draw list.
	 ...
	 * @param atlas Font atlas providing typographic metrics for line placement.
	 */
	void Render(
		...
		float width,
		float height,
		const virasa::ui::FontAtlas& atlas) const;
